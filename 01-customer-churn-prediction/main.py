...
xgboot_SMOTE_model = load_model('models/xgboost-SMOTE.pkl')
...
if selected_customer_option:
  ...
  explanation = explain_prediction(avg_probability, input_dict, selected_customer[["Surname"]].iloc[0])
  st.markdown("---")
  st.subheader("Explanation of Prediction")
  st.markdown(explanation)

  email = generate_email(avg_probability, input_dict, explanation, selected_customer[["Surname"]].iloc[0])
